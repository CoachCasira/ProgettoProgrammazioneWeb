...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_path ?>/assets/css/style.css?v=156">
    <script src="<?= $base_path ?>/assets/js/main.js?v=141" defer></script>
    <script src="<?= $base_path ?>/assets/js/ajax.js?v=136" defer></script>
</head>
<body>
