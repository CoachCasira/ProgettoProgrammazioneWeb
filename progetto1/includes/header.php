...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_path ?>/assets/css/style.css?v=142">
    <script src="<?= $base_path ?>/assets/js/main.js?v=134" defer></script>
    <script src="<?= $base_path ?>/assets/js/ajax.js?v=130" defer></script>
</head>
<body>
