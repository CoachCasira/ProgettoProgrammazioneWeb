...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_path ?>/assets/css/style.css?v=190">
    <script src="<?= $base_path ?>/assets/js/main.js?v=158" defer></script>
    <script src="<?= $base_path ?>/assets/js/ajax.js?v=146" defer></script>
</head>
<body>
