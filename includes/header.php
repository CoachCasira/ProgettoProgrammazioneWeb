...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_path ?>/assets/css/style.css?v=38">
    <script src="<?= $base_path ?>/assets/js/main.js?v=38" defer></script>
    <script src="<?= $base_path ?>/assets/js/ajax.js?v=38" defer></script>
</head>
<body>
