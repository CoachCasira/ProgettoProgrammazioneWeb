...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_path ?>/assets/css/style.css?v=153">
    <script src="<?= $base_path ?>/assets/js/main.js?v=138" defer></script>
    <script src="<?= $base_path ?>/assets/js/ajax.js?v=135" defer></script>
</head>
<body>
