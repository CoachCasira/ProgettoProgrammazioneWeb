...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_path ?>/assets/css/style.css?v=178">
    <script src="<?= $base_path ?>/assets/js/main.js?v=152" defer></script>
    <script src="<?= $base_path ?>/assets/js/ajax.js?v=144" defer></script>
</head>
<body>
