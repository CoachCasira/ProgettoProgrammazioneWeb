...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_path ?>/assets/css/style.css?v=50">
    <script src="<?= $base_path ?>/assets/js/main.js?v=50" defer></script>
    <script src="<?= $base_path ?>/assets/js/ajax.js?v=50" defer></script>
</head>
<body>
