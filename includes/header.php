...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_path ?>/assets/css/style.css?v=39">
    <script src="<?= $base_path ?>/assets/js/main.js?v=39" defer></script>
    <script src="<?= $base_path ?>/assets/js/ajax.js?v=39" defer></script>
</head>
<body>
