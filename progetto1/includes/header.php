...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_path ?>/assets/css/style.css?v=165">
    <script src="<?= $base_path ?>/assets/js/main.js?v=143" defer></script>
    <script src="<?= $base_path ?>/assets/js/ajax.js?v=140" defer></script>
</head>
<body>
