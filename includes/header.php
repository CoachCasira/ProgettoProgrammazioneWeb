...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_path ?>/assets/css/style.css?v=135">
    <script src="<?= $base_path ?>/assets/js/main.js?v=132" defer></script>
    <script src="<?= $base_path ?>/assets/js/ajax.js?v=129" defer></script>
</head>
<body>
